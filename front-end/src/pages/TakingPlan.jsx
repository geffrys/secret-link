                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th>Number</th>
                                    <th>Travelers</th>
                                    <th>Price <button className='addtraveler_button' onClick={() => {
                                        setIsOpen(true)
                    ...
                    <div className='action'>
                        <form action="" onSubmit={onSubmit}>
                            <div>
                                ...
                                {errors.startDate?.type === "required" && (<p>Start Date required</p>)}
                            </div>
                            <div className='action_button_container'>
                                <button className='action_button' type="submit">Confirm</button>
                                <button className='action_button' onClick={() => { setOpenPay(true) }} type="button" disabled={()=>{
                                    if(confirmed){
                                        return false
                                    }else{
                                        return true
